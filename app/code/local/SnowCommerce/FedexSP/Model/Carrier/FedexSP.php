<?php
class SnowCommerce_FedexSP_Model_Carrier_FedexSP extends Mage_Shipping_Model_Carrier_Abstract
    implements Mage_Shipping_Model_Carrier_Interface {
    protected $_code = 'FEDEX_ABOL';
    ...
    {
        return array('FEDEX_ABOL'=>$this->getConfigData('name'));
    }
}